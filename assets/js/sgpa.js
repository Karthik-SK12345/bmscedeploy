...
function addInput(divName, counter) {
    for (i = 1; i <= counter; i++) {
        ...
        newdiv.innerHTML = `<div class='row' style="text-transform:capitalize ;"><div class='col-75' style="  text-transform: capitalize;">     <label class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;  text-transform: lowercase important!;"> Course Code Subject - ${i} </label>
